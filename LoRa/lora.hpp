...
//#define OUTPUT_POWER 0x02 // = 2, output power = 4dBm w/ PA_BOOST, Pout=17-(15-2). REDUCED FOR POWER SUPPLY TEST (ADDED)
...
#define BANDWIDTH_BITMASK 0b00001111 // (ORIGINAL)
// #define BANDWIDTH_BITMASK 0b11110000 // (ADDED)
...
#define OUTPUT_POWER_BITMASK 0xF0 // ORIGINAL
// #define OUTPUT_POWER_BITMASK 0x0F // ADDED
